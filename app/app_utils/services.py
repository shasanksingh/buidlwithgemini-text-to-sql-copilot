...
def get_memory_service():
    """Process-wide memory service backed by Vertex AI Memory Bank or in-memory."""
    ...
    if agent_engine_id := (
        ...
        or "8514587259171766272"
    ):
        from google.adk.memory import VertexAiMemoryBankService

        return VertexAiMemoryBankService(
            project=os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-02-c95bba962a8e"),
            location=os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_LOCATION")
